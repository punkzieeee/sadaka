...
<html class="no-js">
	...
	<div class="main-container">
		<div class="container gallery fadeIn animated">
			<div class="row">
					<a href="assets/images/gallery/sadaka_1.jpg" class="col-md-3 col-sm-4 gallery-item lightbox">
						<img src="assets/images/gallery/thumb/sadaka_1.jpg" alt="">
						<span class="on-hover">
							<span class="hover-caption">SADAKA</span>
						</span>
					</a> <!-- /.gallery-item -->
					<a href="assets/images/gallery/galery1.jpg" class="col-md-3 col-sm-4 gallery-item lightbox">
						<img src="assets/images/gallery/thumb/galery1.jpg" alt="">
						<span class="on-hover">
							<span class="hover-caption">Donasi untuk melawan COVID-19</span>
						</span>
					</a> <!-- /.gallery-item -->
					<a href="assets/images/gallery/galery2.jpg" class="col-md-3 col-sm-4 gallery-item lightbox">
						<img src="assets/images/gallery/thumb/galery2.jpg" alt="">
						<span class="on-hover">
							<span class="hover-caption">Donor Darah</span>
						</span>
						
					</a> <!-- /.gallery-item -->
					<a href="assets/images/gallery/sadaka_2.jpg" class="col-md-3 col-sm-4 gallery-item lightbox">

						<img src="assets/images/gallery/thumb/sadaka_2.jpg" alt="">
						
						<span class="on-hover">
							<span class="hover-caption">SADAKA</span>
						</span>
					</a> <!-- /.gallery-item -->
					<a href="assets/images/gallery/galery3.jpg" class="col-md-3 col-sm-4 gallery-item lightbox">
						<img src="assets/images/gallery/thumb/galery3.jpg" alt="">
						<span class="on-hover">
							<span class="hover-caption">Charity</span>
						</span>
					</a> <!-- /.gallery-item -->
					<a href="assets/images/gallery/galery4.jpg" class="col-md-3 col-sm-4 gallery-item lightbox">
						<img src="assets/images/gallery/thumb/galery4.jpg" alt="">
						<span class="on-hover">
							<span class="hover-caption">Donasi untuk melawan COVID-19</span>
						</span>
					</a> <!-- /.gallery-item -->
					<a href="assets/images/gallery/galery5.jpg" class="col-md-3 col-sm-4 gallery-item lightbox">
						<img src="assets/images/gallery/thumb/galery5.jpg" alt="">
						<span class="on-hover">
							<span class="hover-caption">Donor Darah</span>
						</span>
					</a> <!-- /.gallery-item -->
					<a href="assets/images/gallery/galery6.jpg" class="col-md-3 col-sm-4 gallery-item lightbox">
						<img src="assets/images/gallery/thumb/galery6.jpg" alt="">
						<span class="on-hover">
							<span class="hover-caption">Donor Darah</span>
						</span>
					</a> <!-- /.gallery-item -->
					<a href="assets/images/gallery/sadaka_3.jpg" class="col-md-3 col-sm-4 gallery-item lightbox">
						<img src="assets/images/gallery/thumb/sadaka_3.jpg" alt="">
						<span class="on-hover">
							<span class="hover-caption">SADAKA</span>
						</span>
					</a> <!-- /.gallery-item -->
					<a href="assets/images/gallery/galery7.jpg" class="col-md-3 col-sm-4 gallery-item lightbox">
						<img src="assets/images/gallery/thumb/galery7.jpg" alt="">
						<span class="on-hover">
							<span class="hover-caption">Donasi untuk melawan COVID-19</span>
						</span>
					</a> <!-- /.gallery-item -->
					<a href="assets/images/gallery/galery8.jpg" class="col-md-3 col-sm-4 gallery-item lightbox">
						<img src="assets/images/gallery/thumb/galery8.jpg" alt="">
						<span class="on-hover">
							<span class="hover-caption">Donor Darah</span>
						</span>
					</a> <!-- /.gallery-item -->
					<a href="assets/images/gallery/sadaka_4.jpg" class="col-md-3 col-sm-4 gallery-item lightbox">
						<img src="assets/images/gallery/thumb/sadaka_4.jpg" alt="">
						<span class="on-hover">
							<span class="hover-caption">SADAKA</span>
						</span>
					</a> <!-- /.gallery-item -->
